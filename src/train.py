...
if __name__ == "__main__":
    ...
    ytrain = train_df.damage_grade.values
    yvalid = valid_df.damage_grade.values

    train_df = train_df.drop(["building_id", "damage_grade", "kfold"], axis=1)
    valid_df = valid_df.drop(["building_id", "damage_grade", "kfold"], axis=1)
